...
Thank you for your interest in contributing to gohideit.  
This guide helps make contributing to gohideit simple and efficient for everyone.

### First contribution

If you are starting out contributing to gohideit, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/bapply/gohideit/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the gohideit wants to achieve, please open up an issue first.
